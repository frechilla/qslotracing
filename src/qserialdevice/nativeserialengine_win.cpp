...
bool NativeSerialEnginePrivate::nativeOpen(AbstractSerial::OpenMode mode)
{
    ...
    switch (AbstractSerial::ReadWrite & mode) {
...
#endif
        return false;
    case AbstractSerial::BaudRate110: this->dcb.BaudRate = CBR_110; break;
    case AbstractSerial::BaudRate300: this->dcb.BaudRate = CBR_300; break;
    case AbstractSerial::BaudRate600: this->dcb.BaudRate = CBR_600; break;
    case AbstractSerial::BaudRate1200: this->dcb.BaudRate = CBR_1200; break;
    case AbstractSerial::BaudRate2400: this->dcb.BaudRate = CBR_2400; break;
    case AbstractSerial::BaudRate4800: this->dcb.BaudRate = CBR_4800; break;
    case AbstractSerial::BaudRate9600: this->dcb.BaudRate = CBR_9600; break;
    case AbstractSerial::BaudRate14400: this->dcb.BaudRate = CBR_14400; break;
    case AbstractSerial::BaudRate19200: this->dcb.BaudRate = CBR_19200; break;
    case AbstractSerial::BaudRate38400: this->dcb.BaudRate = CBR_38400; break;
    case AbstractSerial::BaudRate56000: this->dcb.BaudRate = CBR_56000; break;
    case AbstractSerial::BaudRate57600: this->dcb.BaudRate = CBR_57600; break;
    case AbstractSerial::BaudRate115200: this->dcb.BaudRate = CBR_115200; break;
    case AbstractSerial::BaudRate128000: this->dcb.BaudRate = CBR_128000; break;
    case AbstractSerial::BaudRate256000: this->dcb.BaudRate = CBR_256000; break;

    //experimental
    case AbstractSerial::BaudRate230400: this->dcb.BaudRate = CBR_230400; break;
    case AbstractSerial::BaudRate460800: this->dcb.BaudRate = CBR_460800; break;
    case AbstractSerial::BaudRate500000: this->dcb.BaudRate = CBR_500000; break;
    case AbstractSerial::BaudRate576000: this->dcb.BaudRate = CBR_576000; break;
    case AbstractSerial::BaudRate921600: this->dcb.BaudRate = CBR_921600; break;
    case AbstractSerial::BaudRate1000000: this->dcb.BaudRate = CBR_1000000; break;
    case AbstractSerial::BaudRate1152000: this->dcb.BaudRate = CBR_1152000; break;
    case AbstractSerial::BaudRate1500000: this->dcb.BaudRate = CBR_1500000; break;
    case AbstractSerial::BaudRate2000000: this->dcb.BaudRate = CBR_2000000; break;
    case AbstractSerial::BaudRate2500000: this->dcb.BaudRate = CBR_2500000; break;
    case AbstractSerial::BaudRate3000000: this->dcb.BaudRate = CBR_3000000; break;
    case AbstractSerial::BaudRate3500000: this->dcb.BaudRate = CBR_3500000; break;
    case AbstractSerial::BaudRate4000000: this->dcb.BaudRate = CBR_4000000; break;
    default:
#if defined (NATIVESERIALENGINE_WIN_DEBUG)
        qDebug() << "Windows: NativeSerialEnginePrivate::nativeSetBaudRate(AbstractSerial::BaudRate baudRate) \n"
...
void NativeSerialEnginePrivate::recalcTotalReadTimeoutConstant()
{
    if (this->isAutoCalcReadTimeoutConstant) {
        ::DWORD currReadTimeoutConstant = this->ct.ReadTotalTimeoutConstant;
        // Here calculate length one symbol, in bits (count bits in symbol).
        int frameBitsLen = 1; //add start bit
        ...
        //
        quint32 speedValue = this->currInBaudRateToValue();

        if (speedValue > 0) {
            // Without an interval of silence between the characters, in msecs
            quint32 calcReadTimeoutConstant = (frameBitsLen * 1000) / speedValue;
