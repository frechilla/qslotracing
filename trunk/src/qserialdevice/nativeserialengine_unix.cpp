...
bool NativeSerialEnginePrivate::nativeOpen(AbstractSerial::OpenMode mode)
{
    ...
    case AbstractSerial::ReadOnly: flags |= (O_RDONLY); break;
    case AbstractSerial::WriteOnly: flags |= (O_WRONLY); break;
    case AbstractSerial::ReadWrite: flags |= (O_RDWR); break;
    default:
#if defined (NATIVESERIALENGINE_UNIX_DEBUG)
        qDebug() << "Linux: NativeSerialEnginePrivate::nativeOpen(AbstractSerial::OpenMode mode) \n"
...
static speed_t enumBaud_to_nixBaud(AbstractSerial::BaudRate baudRate)
{
    switch (baudRate) {
...
#endif
        break;
    case AbstractSerial::BaudRate50: return B50;
    case AbstractSerial::BaudRate75: return B75;
    case AbstractSerial::BaudRate110: return B110;
    case AbstractSerial::BaudRate134: return B134;
    case AbstractSerial::BaudRate150: return B150;
    case AbstractSerial::BaudRate200: return B200;
    case AbstractSerial::BaudRate300: return B300;
    case AbstractSerial::BaudRate600: return B600;
    case AbstractSerial::BaudRate1200: return B1200;
    case AbstractSerial::BaudRate1800: return B1800;
    case AbstractSerial::BaudRate2400: return B2400;
    case AbstractSerial::BaudRate4800: return B4800;
    case AbstractSerial::BaudRate9600: return B9600;
    case AbstractSerial::BaudRate19200: return B19200;
    case AbstractSerial::BaudRate38400: return B38400;
    case AbstractSerial::BaudRate57600: return B57600;
    case AbstractSerial::BaudRate115200: return B115200;

    //exp
#if defined (Q_OS_LINUX)
    case AbstractSerial::BaudRate230400: return B230400;
    case AbstractSerial::BaudRate460800: return B460800;
    case AbstractSerial::BaudRate500000: return B500000;
    case AbstractSerial::BaudRate576000: return B576000;
    case AbstractSerial::BaudRate921600: return B921600;
    case AbstractSerial::BaudRate1000000: return B1000000;
    case AbstractSerial::BaudRate1152000: return B1152000;
    case AbstractSerial::BaudRate1500000: return B1500000;
    case AbstractSerial::BaudRate2000000: return B2000000;
    case AbstractSerial::BaudRate2500000: return B2500000;
    case AbstractSerial::BaudRate3000000: return B3000000;
    case AbstractSerial::BaudRate3500000: return B3500000;
    case AbstractSerial::BaudRate4000000: return B4000000;
#endif
...
{
    speed_t speed = enumBaud_to_nixBaud(baudRate);
    if (0 == speed)
        return false;

    if (-1 == ::cfsetispeed(&this->tio, speed))  {
#if defined (NATIVESERIALENGINE_UNIX_DEBUG)
...
bool NativeSerialEnginePrivate::nativeSetOutputBaudRate(AbstractSerial::BaudRate baudRate)
{
    ...
    if (-1 == ::cfsetospeed(&this->tio, speed))  {
#if defined (NATIVESERIALENGINE_UNIX_DEBUG)
        qDebug() << "Linux: NativeSerialEnginePrivate::nativeSetOutputBaudRate(AbstractSerial::BaudRate baudRate) \n"
